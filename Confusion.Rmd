...
clean_mat <- plot_confusion_matrix(conf_mat_clean$`Confusion Matrix`[[1]], add_counts = TRUE, add_row_percentages = FALSE, add_col_percentages = FALSE) + ggplot2::labs(x = "Signal", y = "Response")
...
noise_mat <- plot_confusion_matrix(conf_mat_noise$`Confusion Matrix`[[1]], add_counts = TRUE, add_row_percentages = FALSE, add_col_percentages = FALSE, palette = "Oranges") + ggplot2::labs(x = "Signal", y = "Response")
...
clean_amp_mat <- plot_confusion_matrix(conf_mat_clean_amp$`Confusion Matrix`[[1]], add_counts = TRUE, add_row_percentages = FALSE, add_col_percentages = FALSE) + ggplot2::labs(x = "Signal", y = "Response")
...
noise_amp_mat<-plot_confusion_matrix(conf_mat_noise_amp$`Confusion Matrix`[[1]], add_counts = TRUE, add_row_percentages = FALSE, add_col_percentages = FALSE, palette = "Oranges") + ggplot2::labs(x = "Signal", y = "Response")
